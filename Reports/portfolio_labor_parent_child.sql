SELECT
  ...
  CASE
    WHEN PROJECT_TYPE_ID IN ('baseline','Production_Support') THEN BUDGET_LABOR_COST - YTD_BUDGET_LABOR_COST
...
FROM
  ...
  (
    SELECT INVESTMENTS.ID PROJECT_ID,
           ...
           -- ytd budget costs
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Labor' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_LABOR_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Software' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_SOFTWARE_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Hardware' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_HARDWARE_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'ProfServ' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_PROFSERV_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Other' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_OTHER_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'OtherCom' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2) ELSE 0 END YTD_BUDGET_OTHERCOM_COST,
           -- forecast costs
     ...
     WHERE     PLANS.ID = DETAILS.PLAN_ID
         ...
         AND TO_CHAR(COSTS.START_DATE,'YYYY') = TO_CHAR(SYSDATE,'YYYY')
    ...
    SELECT WIP.INVESTMENT_ID,
     ...
     WHERE     WIP_VALUES.TRANSNO = WIP.TRANSNO
           ...
           AND TO_CHAR(WIP.MONTH_BEGIN,'YYYY') = TO_CHAR(SYSDATE,'YYYY')
    ...
    SELECT HIERARCHIES.PARENT_ID PROJECT_ID,
           ...
           -- ytd budget costs
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Labor' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_LABOR_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Software' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_SOFTWARE_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Hardware' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_HARDWARE_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'ProfServ' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_PROFSERV_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'Other' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_OTHER_COST,
           CASE WHEN PLANS.PLAN_TYPE_CODE = 'BUDGET' AND PLANS.IS_PLAN_OF_RECORD = 1 AND TO_CHAR(COSTS.START_DATE,'MM') <= TO_CHAR(SYSDATE,'MM') AND CLASSES.TRANSCLASS = 'OtherCom' THEN ROUND(COSTS.SLICE*(TO_DATE(COSTS.FINISH_DATE)-TO_DATE(COSTS.START_DATE)),2)*HIERARCHIES.DEFAULT_ALLOC_PCT ELSE 0 END YTD_BUDGET_OTHERCOM_COST,
           -- forecast costs
    ...
    SELECT HIERARCHIES.PARENT_ID,
     ...
     WHERE     WIP_VALUES.TRANSNO = WIP.TRANSNO
           ...
           AND WIP.STATUS NOT IN (2, 8)
           AND WIP_VALUES.CURRENCY_TYPE = 'BILLING'
           AND TO_CHAR(MONTH_BEGIN,'YYYY') = TO_CHAR(SYSDATE,'YYYY')
           AND TO_CHAR(MONTH_BEGIN,'MM') <= TO_CHAR(SYSDATE,'MM')
...
WHERE 
  ...
  AND (
        PORTFOLIOS.ID = CASE WHEN 0 = 0 THEN 5008000 ELSE 5008000 END
      )
  AND (
        PROJECT_MANAGERS.USER_ID = CASE WHEN 0 = 0 THEN PROJECT_MANAGERS.USER_ID ELSE 0 END
      )
  AND (
        NVL(DEPARTMENT_DETAILS.BUCIO_GROUP,0) = CASE WHEN 0 = 0 THEN NVL(DEPARTMENT_DETAILS.BUCIO_GROUP,0) ELSE 0 END
      )
  AND (
        NVL(CASE WHEN DEPARTMENTS.BRM_ID,0) = CASE WHEN 0 = 0 THEN NVL(DEPARTMENTS.BRM_ID,0) ELSE 0 END
      )
)
GROUP BY
  PORTFOLIO_ID,
